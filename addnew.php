                                ...
                                <div class="row register-form">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="address" class="form-control" placeholder="Password *" name="address" />
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <input type="date" class="form-control" placeholder="birthdate " name="birthday" />
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <input type="file" class="form-control" placeholder="Birthdate " name="fileToUpload" />
                                        </div>
